...
var bookList: Array<Book> = [book1, book2, book3]

export default function BookCarousell() {
    ...
    return <div className='w-full flex justify-around items-center bg-white'>
        ...
        <div className="w-book h-book drop-shadow-book bookCover">
            ...
            <div className="bookside front">
                <img className="w-book h-book" src={book2.imagesPath} alt={book2.name} />
            </div>
            <div className="bookside back w-book h-book bg-gray-100">
                
                <div className="p-8">
                    <h1 className="text-2xl">{book2.name}</h1>
                    <h2 className="italic pb-2">{book2.author} - {book2.releaseDate.toDateString()}</h2>
                    <p className="overflow-y-auto max-h-klappentext">{book2.klappentext}</p>
                </div>
            </div>
        </div>
